...
struct adaptive_units
{
  ...
  // The coefficient of the max distance.  We multiply the length of
  // the longest shortest path to get the max_dist, i.e., the reach of
  // the m_m_max modulation level.
  static constexpr double m_max_dist_coeff = 1.5;
  ...
  static void
  longest_shortest_path(Cost length)
  {
    m_max_dist = m_max_dist_coeff * length;
